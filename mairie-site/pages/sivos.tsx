    ...
    <>
      ...
      <main className="main-page">
        <section>
          ...
          <p>Nous sommes engagés à travailler en étroite collaboration avec les familles, les enseignants et les collectivités locales pour assurer le bien-être et la réussite des enfants dans nos écoles. Merci de votre visite et de votre intérêt pour le SIVOS &rsquo;!
          </p>
          </div>
        </section>
        <section>
